...
/* in gauge_stuff.c */
extern char gauge_action_description[128UL];
extern int gauge_action_nloops;
extern int gauge_action_nreps;
...
/* The rest are optional */
  write_gauge_info_item(fp,"action.description","%s","\"Gauge plus fermion (improved)\"",0,0);
  write_gauge_info_item(fp,"gauge.description","%s",gauge_action_description,0,0);
