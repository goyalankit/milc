...
void f_meas_imp( field_offset phi_off, field_offset xxx_off, float mass ){
    float r_psi_bar_psi_even, i_psi_bar_psi_even;
    float  r_psi_bar_psi_odd, i_psi_bar_psi_odd;
    float r_ferm_action;
...
BOMB THE COMPILE
    ...
    float r_pb_dMdmu_p_e, i_pb_dMdmu_p_e;
    float r_pb_dMdmu_p_o, i_pb_dMdmu_p_o;
    float r_pb_d2Mdmu2_p_e, i_pb_d2Mdmu2_p_e;
    float r_pb_d2Mdmu2_p_o, i_pb_d2Mdmu2_p_o;
    double MidM_MidM;
#endif
