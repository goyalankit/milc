...
#if defined(MPI) && defined(MYNODE_INLINE)
#ifndef _MYNODE_INLINE_INCLUDE_
#ifndef _COM_MPI_SOURCE
extern int inl_mynode;
#endif
#define _MYNODE()	inl_mynode 
#define _MYNODE_INLINE_INCLUDE_
#endif
#else
#define _MYNODE()	mynode()
#endif
